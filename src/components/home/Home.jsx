    ...
    <div className="w-full bg-white">
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-end gap-8 pb-10">
        <div className="flex flex-col items-center lg:items-start gap-4 text-center lg:text-left max-w-xl">
          <h1 className="mt-6 lg:m-0 text-3xl md:text-3xl lg:text-[40px] font-bold bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-transparent">
            Bootstrap 5 theme
          </h1>
          <h2 className="text-xl lg:text-3xl text-gray-700">
